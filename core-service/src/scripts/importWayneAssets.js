...
if (!filePath) throw new Error("Usage: node src/scripts/importWayneAssets.js /path/to/file.xlsx");

const WAYNE_FACILITY_ID = new mongoose.Types.ObjectId("69cfa11c41f774bb2a19f6ba");
...
const summary = await mongoose.connection.db.collection("assets").aggregate([
  { $match: { facilityId: WAYNE_FACILITY_ID } },
